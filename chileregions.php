 ...
 */
function chileregions_stateConfig() {
  $config = array(
    ...
    'states' => array(
      ...
      'Los Lagos' => '8',
      'Los Rios' => '9',
      'Magallanes y Antartica Chilena' => '10',
      'Maule' => '11',
 ...
 *   Success true/false.
 */
function chileregions_loadProvinces() {
  $stateConfig = chileregions_stateConfig();
